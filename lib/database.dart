...
class DatabaseService {
    ...
    void updateItem(int id, {String? item, int? buyDate, int? expiryDate,
    int? stock, String? thumbnail, String? memo}) async {
        ...
        final db = await database;
        await db.update(_fridgeTableName,
        updateValues,
    ...
    Future<List<Map<String, dynamic>>> getItem({int? id, String? item,
    int? buyDate, int? expiryDate, int? stock,
